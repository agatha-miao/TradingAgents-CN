        ...
        <el-card v-show="activeTab === 'system'" class="config-content" shadow="never">
          ...
          <el-form :model="systemSettings" label-width="150px" v-loading="systemLoading">
            ...
            <el-form-item label="快速分析模型">
              ...
              <div class="setting-description">用于市场分析、新闻分析、基本面分析、研究员等，响应速度快（推荐：gpt-5.4-mini）</div>
            </el-form-item>
            ...
            <el-form-item label="深度决策模型">
              ...
              <div class="setting-description">用于研究管理者综合决策、风险管理者最终评估，推理能力强（推荐：gpt-5.4-mini）</div>
            </el-form-item>
...
const loadSystemSettings = async () => {
  ...
  try {
    ...
    systemSettings.value = {
      quick_analysis_model: 'gpt-5.4-mini',
      deep_analysis_model: 'gpt-5.4-mini',
